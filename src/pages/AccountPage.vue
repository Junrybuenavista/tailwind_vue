    ...
    <div class="px-6 mt-12">
      <div class="mb-12 grid gap-y-10 gap-x-6 md:grid-cols-2 xl:grid-cols-4">
        ...
        <div class="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md">
          ...
          <div class="p-4 text-right">
            <p class="block antialiased font-sans text-sm leading-normal font-normal text-blue-gray-600">Absences</p>
            <h4 class="block antialiased tracking-normal font-sans text-2xl font-semibold leading-snug text-blue-gray-900">62</h4>
          </div>
          <div class="border-t border-blue-gray-50 p-4">
            <p class="block antialiased font-sans text-base leading-relaxed font-normal text-blue-gray-600">
...
export default {  
    ...
    data(){
        ...
        .catch((error) => {
                ...
                if(error.response.data.error.message==='jwt expired'||error.response.data.error.message==='jwt malformed'){                                
                    renewToken.checkToken(self.$router)
    ...
    methods: {
      changeVal(value) { 
        this.$refs.response.innerHTML = 'Profile: '+value;
      }
    }
