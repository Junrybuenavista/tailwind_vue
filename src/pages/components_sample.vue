        ...
        <div class="flex   text-center">
          ...
          <div class="p-4 sm:w-1/2 lg:w-1/3 w-full hover:scale-105 duration-500">
            <div class=" flex items-center  justify-between p-4  rounded-lg bg-white shadow-indigo-50 shadow-xl">
              <div>
                <h2 class="text-gray-900 text-lg font-bold">BS-IT</h2>
                <h3 class="text-center mt-2 text-xl font-bold text-orange-500 text-left">10:00 - 11:00pm</h3>
                <p class="text-sm font-semibold text-gray-400">bachelor's degree awarded for an undergraduate program in the information technology</p>
                <button class="text-sm mt-6 px-4 py-2 bg-orange-400  text-white rounded-lg  tracking-wider hover:bg-orange-500 outline-none">Add Student</button>
              </div>
            </div>
