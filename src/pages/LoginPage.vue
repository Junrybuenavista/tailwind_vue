...
<div
    ...
    <div class="w-full">
        <div class="text-center">
            ...
            <p class="mt-2 text-gray-500">{{responseText}}</p>
        </div>
        <div class="mt-5">
            <form @submit.prevent="loginAccount" action="">
                <div class="relative mt-6">
                    <input  v-model="form.email" type="email" name="email" id="email" placeholder="Email Address" class="peer mt-1 w-full border-b-2 border-gray-300 px-0 py-1 placeholder:text-transparent focus:border-gray-500 focus:outline-none" autocomplete="NA" />
                ...
                <div class="relative mt-6">
                    <input v-model="form.password" type="password" name="password" id="password" placeholder="Password" class="peer peer mt-1 w-full border-b-2 border-gray-300 px-0 py-1 placeholder:text-transparent focus:border-gray-500 focus:outline-none" />
