          ...
          <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-gray-50">
              <tr>
                ...
                <th scope="col" class="px-6 py-3 text-start text-xs font-medium text-gray-500 uppercase">Category name</th>
            ...
            <tbody class="divide-y divide-gray-200">      
              ...
              <tr v-for="item in items" :key="item.id">
                ...
                <td class="px-6 py-4 whitespace-nowrap text-start text-sm font-medium text-gray-800">{{item.name}}</td>
                <td class="px-6 py-4 whitespace-nowrap text-start text-sm text-gray-800">{{item.description}}</td>
